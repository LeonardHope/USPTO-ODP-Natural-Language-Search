#!/usr/bin/env python3
"""USPTO Open Data Portal Search — Setup Wizard.
...
3. Prompts for the ODP API key, shows a masked preview
4. Saves the key to a .env file (git-ignored)
...
def write_env(values: dict) -> None:
    ...
    lines = [
        "# USPTO Open Data Portal Search - API Key",
...
def main():
    print("=" * 60)
    print("  USPTO Open Data Portal Search — Setup Wizard")
    print("=" * 60)
    print()
